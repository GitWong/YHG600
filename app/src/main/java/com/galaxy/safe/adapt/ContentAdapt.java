...
public class ContentAdapt extends BaseAdapter {

    private String[] names;
    private Context mContext;
    private int[] icons;

    public ContentAdapt(Context context, String[] names,int[] icons) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_right_grid, null);
