...
public class SampletypeActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sampletype);
        initView();
        initToolbar();
        initData();
    ...
    private void initData() {
        ...
        cursor = sdb.query("galaxy_sample_type", new String[]{"type_name", "type_desc", "type_id"}, null, null, null, null, null);
    ...
    private void initToolbar() {
        ...
        tl_bar.setTitle("样品种类页面");
        tl_bar.setSubtitle("样品种类");
                ...
                view.findViewById(R.id.bt_ok).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!TextUtils.isEmpty(et_name.getText().toString().trim())) {
                            ...
                            cv.put("type_desc", des);
                            cv.put("type_id", max + 1);


                            long d = sdb.insert("galaxy_sample_type", null, cv);
                            if (d == -1) {
                                Toast.makeText(SampletypeActivity.this, "保存失败", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(SampletypeActivity.this, "储存数据库成功", Toast.LENGTH_SHORT).show();
                            }
                            initData();
                            dialog1.dismiss();
                        } else {
                            Toast.makeText(SampletypeActivity.this, "名称不能为空", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        view.findViewById(R.id.bt_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cv1.put("type_name", name);
                cv1.put("type_desc", des);
                int d = sdb.update("galaxy_sample_type", cv1, "type_name=?", new String[]{name1});
                if (d == -1) {
                    Toast.makeText(SampletypeActivity.this, "修改失败", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SampletypeActivity.this, "修改成功", Toast.LENGTH_SHORT).show();
                }
                initData();
                dialog1.dismiss();
            }
    ...
    class SampleTypeAdapt extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(SampletypeActivity.this, R.layout.item_sample_type, null);
            ...
            holder.iv_delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog.Builder build2 = new AlertDialog.Builder(SampletypeActivity.this);
                    build2.setTitle("删除样本种类").setMessage("确定删除" + type_list.get(position).getSample_name()).setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            sdb.delete("galaxy_sample_type", "type_name=?", new String[]{type_list.get(position).getSample_name()});
                            initData();
                        }
