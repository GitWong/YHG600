...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(final Bundle icicle) {
        ...
        String c = getIntent().getStringExtra("currentCamera");
        if (c != null) {
            currentCamera = Integer.valueOf(c);
        }
        ...
        change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("currentCamera", currentCamera);
    ...
    protected void onResume() {
        ...
        if (isHasSurface) {
            ...
            initCamera(scanPreview.getHolder(), currentCamera);
        } else {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (!isHasSurface) {
            isHasSurface = true;
            initCamera(holder, currentCamera);
        }
    }
    ...
    private void initCamera(SurfaceHolder surfaceHolder, int currentCamera) {
        ...
        try {
            cameraManager.openDriver(surfaceHolder, currentCamera);
